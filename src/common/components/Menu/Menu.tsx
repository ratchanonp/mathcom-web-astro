                    ...
                    <a href="/" className="flex items-center">
                        ...
                        <div className="flex w-full justify-center font-kanit font-medium text-white">
                            <span>
                                ...
                                <br className="hidden xs:block lg:hidden" /> COMPUTER SCIENCE
                            </span>
                        </div>
                    </a>
                    ...
                    <ul className=" divide-y">
                        ...
                        <Accordion type="single" collapsible>
                            <AccordionItem value="item-1">
                                <AccordionTrigger className="group flex w-full items-center text-white [&[data-state=open]>svg.back-icon]:rotate-180 hover:bg-white/10">
