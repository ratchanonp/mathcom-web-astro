...
const FacultyCard = (props: Props) => {
    ...
    return (
        <a href={`/th/people/${slug}`} className="border border-gray-300 shadow-sm">
            {picture ? (
                <figure>
                    <img className="w-full aspect-square object-cover object-top" src={picture} alt={title} />
                </figure>
            ) : (
                <div className="w-full aspect-square bg-gray-200 justify-center items-center flex">
                    <svg
