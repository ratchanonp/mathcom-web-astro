	...
	return (
		<div className="border border-gray-300 shadow-xs">
			...
			<div className="p-2.5 font-kanit md:p-5">
				<h2 className="h-10 animate-pulse bg-gray-200 text-base font-medium md:text-2xl"></h2>
				<p className="h-5 w-32 animate-pulse bg-gray-200 text-xs capitalize text-gray-400 md:mt-2 md:text-base"></p>
			</div>
		</div>
	);
};
