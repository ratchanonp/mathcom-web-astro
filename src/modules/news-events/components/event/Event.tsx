        ...
        <article className="grid justify-items-center p-5 hover:bg-gray-200">
            <header>
                <time
                    ...
                    dateTime={formatISO(event.event_start)}
                >
                    <span className="text-yellow-500 text-3xl font-bold uppercase">
                        {format(event.event_start, "MMM dd")}
                    </span>
                    <span className="text-yellow-500">
                        {format(event.event_start, "hh:mm aa")}
                    </span>
                </time>
