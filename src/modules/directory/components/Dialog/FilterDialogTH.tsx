		...
		<Dialog>
			<DialogTrigger asChild>
				<button className="inline-flex items-center rounded border-[1px] border-gray-300 px-5 py-2.5 text-xl">
					...
					<span className="hidden lg:block">ตัวกรอง</span>
				</button>
			</DialogTrigger>
			<DialogContent className="max-w-screen-md">
				<DialogHeader className="flex justify-between border-b-[1px] border-b-gray-200 p-5">
					<div className="h-6 w-6" />
					<DialogTitle className="text-xl text-gray-800">ตัวกรอง</DialogTitle>
					<DialogClose asChild>
						<button>
				...
				<DialogFooter className="flex justify-between border-t-[1px] border-t-gray-200 p-5">
					...
					<DialogClose asChild>
						<button className="rounded-lg bg-gray-800 px-5 py-2.5 text-lg text-white" type="submit" form="filter">
							ใช้งาน
						</button>
					</DialogClose>
				</DialogFooter>
