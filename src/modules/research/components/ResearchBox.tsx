...
const ResearchBox = (props: Props) => {
	...
	return (
		<article className="relative flex min-h-60 w-full flex-col justify-between border-2 border-slate-800 bg-slate-900 p-5 text-white sm:w-1/2 md:w-1/3 lg:w-1/4">
